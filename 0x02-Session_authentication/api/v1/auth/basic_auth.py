...
class BasicAuth(Auth):
    ...
    def extract_base64_authorization_header(self,
        ...
        """
        Extract Base64 part of the Authorization header for Basic
        Authorization
        """
    ...
    def user_object_from_credentials(self, user_email: str,
        ...
        """
        it Returns User instance based on email and password
        """
    ...
    def current_user(self, request=None) -> TypeVar('User'):
        """
        Return User instance based on received request
        """
